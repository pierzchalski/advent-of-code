...
fn problem_1_examples() {
    let wire1 = "R8,U5,L5,D3";
    let wire2 = "U7,R6,D4,L4";
    let result = closest_distance(wire1, wire2);
    assert_eq!(result, 6);
